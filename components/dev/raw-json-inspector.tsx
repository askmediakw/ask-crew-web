    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-[110] flex" onClick={() => setOpen(false)}>
          <div className="flex-1 bg-foreground/50 backdrop-blur-sm" />
          <aside
            className="flex h-full w-full max-w-md flex-col border-l border-border bg-popover"
          ...
          >
            <div className="flex items-center justify-between border-b border-border p-4">
              ...
              <button
                ...
                className="rounded-lg p-1 text-muted-foreground transition hover:bg-secondary/50 hover:text-foreground"
                aria-label="إغلاق"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              {apiCalls.map((c) => (
                <div key={c.id} className="mb-2 overflow-hidden rounded-xl border border-border">
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-2 bg-secondary/50 px-3 py-2 text-left transition hover:bg-secondary"
                  >
                  ...
                  {selected === c.id && (
                    <pre className="max-h-60 overflow-auto bg-foreground/40 p-3 font-mono text-[11px] leading-relaxed text-success scrollbar-thin">
